...
pgbench -h $HOST -p $PORT -U $USER -f ProducerConsumer/ActivityWatcher/select_custom_pgbench.sql -c 500 -T 10 $DBNAME

# Run DELETE operations
pgbench -h $HOST -p $PORT -U $USER -f ProducerConsumer/ActivityWatcher/delete_custom_pgbench.sql -c 500 -T 10 $DBNAME
